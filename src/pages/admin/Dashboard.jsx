  ...
  return (
    <div>
      ...
      <div className='border min-h-screen bg-yellow-400 '>
        ...
        <div className='flex justify-between border bg-slate-100 p-3 rounded-xl mx-5 my-3 shadow-lg'>
          <div>
        ...
        <div className='shadow-lg bg-slate-100 rounded-xl text-center mt-5 mx-4 '>
          <div className='border-b '>
