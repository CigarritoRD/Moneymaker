    ...
    <div className='h-screen w-full relative z-10 '>
      <div className='bg-black/60 w-full h-full absolute grid place-content-center '>
        <h1
          data-aos='fade-up'
          data-aos-delay='50'
          className=' drop-shadow-lg text-white text-4xl md:text-6xl uppercase text-center font-extrabold'
        >
        ...
        <h2
          data-aos='fade-left'
          data-aos-delay='50'
          className='drop-shadow-lg uppercase text-4xl md:text-6xl text-center font-extrabold text-orange-500'
        >
      ...
      <div className='absolute bottom-[80px] left-[50%] translate-x-[-50%]'>
        <button
          data-aos='fade-up'
          data-aos-delay='150'
          className=' border-2 min-w-[300px] animate-pulse hover:animate-none hover:bg-[#EC994B] hover:border-none hover:shadow-xl hover:shadow-black hover:scale-105 duration-300 font-bold py-3 px-6 text-xl text-white rounded-xl uppercase '
        >
          nuestros planes
        </button>
      </div>
